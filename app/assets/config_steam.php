<?php
    $f3 = Base::instance();
    session_start();
    $f3->set('steam_apikey',$db->exec('SELECT value FROM settings WHERE id = 17'));
    $steam_apikey = $f3->get('steam_apikey');
    $steamauth['apikey'] = $steam_apikey[0]['value']; // Your Steam WebAPI-Key found at https://steamcommunity.com/dev/apikey
