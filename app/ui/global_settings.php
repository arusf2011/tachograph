    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <?php
            if(isset($_SESSION['success']) && $_SESSION['success'] == 'mod_setting')
            {
              ?>
                <div class="alert alert-success">
                  <?= $f3->get('modsetting_success') ?>
                </div>
              <?php
                        ...
                        <div class="row mt-3">
                          ...
                          <div class="col-md-9 justify-content-start form-row">
                            <select id="setting<?= $setting['id'] ?>" name="value" class="form-control col-md-8">
                              <option value="0" <?php if(intval($setting['value']) == false) echo 'selected' ?> ><?= $f3->get('closed') ?></option>
                              <option value="1" <?php if(intval($setting['value']) == true) echo 'selected' ?> ><?= $f3->get('open') ?></option>
                            </select>
                  ...
                  else if($setting['id'] == 13)
                  {
                    ...
                    <form method="post" class="" action="./change_setting/<?= $setting['id'] ?>">
                      <div class="row mt-3">
                        ...
                        <div class="col-md-9 justify-content-start form-row">
                          <input type="password" id="setting<?= $setting['id'] ?>" name="value" class="form-control col-md-8" value="<?= $setting['value'] ?>">
                          <div class="col-md-1"></div>
                          <button type="submit" class="btn btn-success col-md-3"><i class="fas fa-edit"></i> <?= $f3->get('change_setting') ?></button>
                        </div>
                      </div>
                    ...
                    ?>
                      <form method="post" class="" action="./change_setting/<?= $setting['id'] ?>">
                        <div class="row mt-3">
                          ...
                          <div class="col-md-9 justify-content-start form-row">
                            <input type="text" id="setting<?= $setting['id'] ?>" name="value" class="form-control col-md-8" value="<?= $setting['value'] ?>">
                            <div class="col-md-1"></div>
                            <button type="submit" class="btn btn-success col-md-3"><i class="fas fa-edit"></i> <?= $f3->get('change_setting') ?></button>
                          </div>
                        </div>
