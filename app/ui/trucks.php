<?php
  $f3=Base::instance();
  session_start();
  $f3->set('trucks_arr',$db->exec('SELECT * FROM trucks'));
  $trucks = $f3->get('trucks_arr');
...
<head>
  ...
  <title><?php echo $f3->get('dashboard_trucks_title'); ?></title>
      ...
      <li class="nav-item">
        ...
        <div id="collapseThree" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active text-<?= $global_settings[17]['value'] ?>" href="./trucks"><i class="fas fa-truck fa-fw"></i> <?php echo $f3->get('trucks'); ?></a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <?php
            if(isset($_SESSION['success']) && $_SESSION['success'] == 'add_truck')
            {
              ?>
                <div class="alert alert-success">
                  <?= $f3->get('addtruck_success') ?>
                </div>
              <?php
              unset($_SESSION['success']);
            }
            else if(isset($_SESSION['success']) && $_SESSION['success'] == 'del_truck')
            {
              ?>
                <div class="alert alert-success">
                  <?= $f3->get('deltruck_success') ?>
                </div>
              <?php
              unset($_SESSION['success']);
            }
          ...
          <div class="card shadow border-<?= $global_settings[17]['value'] ?>">
            <div class="card-header">
              <h1 class="h3 text-gray-800"><?php echo $f3->get('trucks'); ?></h1>
            </div>
            <div class="card-body">
                    ...
                    <?php
                      foreach($trucks as $truck)
                      {
                        ...
                        <tr>
                          ...
                          <td><?php if($truck['game'] == false) echo 'ETS2'; else echo 'ATS' ?></td>
                          <td class="text-center"><a href="./delete_truck/<?= $truck['id'] ?>"><button class="btn btn-danger"><i class="fas fa-trash"></i> <?= $f3->get('delete') ?></button></a></td>
                        </tr>
                        <?php
                      }
                    ?>
              ...
              <hr>
              <h4><b><?= $f3->get('add_truck') ?></b></h4>
              <div class="form-inline">
                <form method="POST" action="./new_truck">
                  <p>
