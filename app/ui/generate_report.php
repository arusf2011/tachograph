    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid bg-light">
          <h1 class="page-title"><?php echo $f3->get('generate_report') ?></h1>
          <?php 
          ...
          ?>
          <form method="POST" action="./generate_report_user">
            <?php
              if($roles[$role-1]['admin'] == true)
              {
                $f3->set('all_users',$db->exec('SELECT * FROM users'));
                $users = $f3->get('all_users');
                ?> 
                  <div class="text-center">
                    <p><?= $f3->get('select_user') ?></p>
                    <select name="user_id" id="user_id" class="form-control selectpicker col-sm-3" data-live-search="true">
                      <?php
            ...
            <div class="row mb-3">
                <div class="col-sm-6">
                  <label for="datepicker1" class="mt-3"><?= $f3->get('date_beg_report') ?></label>
                  <input id="datepicker1" />
                  <input type="hidden" name="date_beg" id="date_beg">  
                </div>
                <div class="col-sm-6">
                  <label for="datepicker2" class="mt-3"><?= $f3->get('date_end_report') ?></label>
                  <input id="datepicker2" />
                  <input type="hidden" name="date_end" id="date_end">
                </div>
            </div>
            <div class="text-center mt-2">
              <button class="btn btn-success"><i class="fas fa-download"></i> <?php echo $f3->get('generate_report') ?></button>
            </div>
          </form>
        </div>
      </div>
  ...
  <script>
    ...
    $('#datepicker1').datepicker({
      ...
      change: function () {
        ...
        document.getElementById('date_beg').value = datepicker1.value();
      }
    });
    ...
    $('#datepicker2').datepicker({
      ...
      change: function () {
        ...
        document.getElementById('date_end').value = datepicker2.value();
      }
    });
