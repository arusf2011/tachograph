...
<head>
  ...
  <title><?php echo $f3->get('dashboard_roles_title'); ?></title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <?php
            if(isset($_SESSION['success']) && $_SESSION['success'] == 'add_role')
            {
              ?>
                <div class="alert alert-success">
                  <?= $f3->get('addrole_success') ?>
                </div>
              <?php
              unset($_SESSION['success']);
            }
            else if(isset($_SESSION['success']) && $_SESSION['success'] == 'del_role')
            {
              ?>
                <div class="alert alert-success">
                  <?= $f3->get('delrole_success') ?>
                </div>
              <?php
              unset($_SESSION['success']);
            }
          ...
          <div class="card shadow border-<?= $global_settings[17]['value'] ?>">
            ...
            <div class="card-body">
                ...
                <table id="dataTable" class="display table table-striped table-bordered" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      ...
                      <th><?= $f3->get('is_admin') ?></th>
                      <th><?= $f3->get('edit_user') ?></th>
                  ...
                  <tbody>
                    <?php
                      foreach($roles as $role)
                      {
                        ...
                        <tr>
                          <td><?= $role['id'] ?></td>
                          <td class="<?= $role['color'] ?>"><?= $role['name'] ?></td>
                          <td><?= $role['short_name'] ?></td>
                          <td><?php if($role['admin'] == false) echo $f3->get('no'); else echo $f3->get('yes') ?></td>
                          <td><?php if($role['edit_user'] == false) echo $f3->get('no'); else echo $f3->get('yes') ?></td>
                          <td class="text-center"><?php if($role['id'] == 1 || $role['id'] == 2) echo $f3->get('role_unremovable'); else { ?><a href="./delete_role/<?= $role['id'] ?>"><button class="btn btn-danger"><i class="fas fa-trash"></i> <?= $f3->get('delete') ?></button></a><?php } ?></td>
                        </tr>
                        <?php
                      }
                    ?>
              ...
              <hr>
              <h4><b><?= $f3->get('add_role') ?></b></h4>
              <div class="form-inline">
                <form method="POST" action="./new_role">
                  <p>
                    ...
                    <select name="admin" class="form-control">
                      <option value=""><?= $f3->get('is_admin') ?></option>
                      <option value="0"><?= $f3->get('yes') ?></option>
                      <option value="1"><?= $f3->get('no') ?></option>
                    </select>
                    <select name="edit_user" class="form-control">
                      <option value=""><?= $f3->get('edit_user') ?></option>
                      <option value="0"><?= $f3->get('yes') ?></option>
                      <option value="1"><?= $f3->get('no') ?></option>
                    </select>
                    <select name="color" class="form-control">
                      <option value=""><?= $f3->get('color_of_role') ?></option>
                      <option value="text-default" class="text-default"><?= $f3->get('default') ?></option>
                      <option value="text-primary" class="text-primary"><?= $f3->get('blue') ?></option>
                      <option value="text-secondary" class="text-secondary"><?= $f3->get('grey') ?></option>
                      <option value="text-danger" class="text-danger"><?= $f3->get('red') ?></option>
                      <option value="text-success" class="text-success"><?= $f3->get('green') ?></option>
                      <option value="text-info" class="text-info"><?= $f3->get('turquoise') ?></option>
                      <option value="text-warning" class="text-warning"><?= $f3->get('yellow') ?></option>
                    </select>
