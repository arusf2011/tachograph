...
<head>
  ...
  <title><?php echo $f3->get('dashboard_listusers_title'); ?></title>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item active text-<?= $global_settings[17]['value'] ?>" href="./list_users"><i class="fas fa-list-alt fa-fw"></i> <?php echo $f3->get('list'); ?></a>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex mb-4">
            <h1 class="h3 text-gray-800"><?php echo $f3->get('list_users'); ?></h1>
          </div>
          <?php
            if(isset($_SESSION['success']) && $_SESSION['success'] == 'add_user')
            {
              ?>
                <div class="alert alert-success">
                  <?= $f3->get('adduser_success') ?>
                </div>
              <?php
              unset($_SESSION['success']);
            }
            if(isset($_SESSION['success']) && $_SESSION['success'] == 'deleted_user')
            {
              ?>
                <div class="alert alert-success">
                  <?= $f3->get('deluser_success') ?>
                </div>
              <?php
              unset($_SESSION['success']);
            }
            if(isset($_SESSION['success']) && $_SESSION['success'] == 'mod_role')
            {
              ?>
                <div class="alert alert-success">
                  <?= $f3->get('modrole_success') ?>
                </div>
              <?php
              unset($_SESSION['success']);
            }
            if(isset($_SESSION['success']) && $_SESSION['success'] == 'reset_pass')
            {
              ?>
                <div class="alert alert-success">
                  <?= $f3->get('reset_pass_success') ?>
                </div>
              <?php
              unset($_SESSION['success']);
            }
          ...
          <div class="row">
            <?php
              require_once './app/list_users_function.php';
            ?>
          </div>
        <!-- /.container-fluid -->
  ...
  <script>
    $(document).ready(function(){
      $('.lookup_btn').on('click',function(){
          ...
          $('.modal-body-user').load(data_href,function(){
