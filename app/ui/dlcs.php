...
<head>
  ...
  <title><?php echo $f3->get('dashboard_dlcs_title'); ?></title>
      ...
      <li class="nav-item">
        ...
        <div id="collapseThree" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active text-<?= $global_settings[17]['value'] ?>" href="./dlcs"><i class="fas fa-file-download fa-fw"></i> <?php echo $f3->get('dlcs'); ?></a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <?php
            if(isset($_SESSION['success']) && $_SESSION['success'] == 'add_dlc')
            {
              ?>
                <div class="alert alert-success">
                  <?= $f3->get('adddlc_success') ?>
                </div>
              <?php
              unset($_SESSION['success']);
            }
            else if(isset($_SESSION['success']) && $_SESSION['success'] == 'del_dlc')
            {
              ?>
                <div class="alert alert-success">
                  <?= $f3->get('deldlc_success') ?>
                </div>
              <?php
              unset($_SESSION['success']);
            }
          ...
          <div class="card shadow border-<?= $global_settings[17]['value'] ?>">
            <div class="card-header">
              <h1 class="h3 text-gray-800"><?php echo $f3->get('dlcs'); ?></h1>
            </div>
            <div class="card-body">
                    ...
                    <?php
                      foreach($dlcs as $dlc)
                      {
                        ...
                        <tr>
                          <td><?= $dlc['id'] ?></td>
                          <td><?= $dlc['name'] ?></td>
                          <td><?= $dlc['short_name'] ?></td>
                          <td class="text-center"><a href="./delete_dlc/<?= $dlc['id'] ?>"><button class="btn btn-danger"><i class="fas fa-trash"></i> <?= $f3->get('delete') ?></button></a></td>
                        </tr>
                        <?php
                      }
                    ?>
              ...
              <hr>
              <h4><b><?= $f3->get('add_dlc') ?></b></h4>
              <div class="form-inline">
                <form method="POST" action="./new_dlc">
                 <p><input type="text" class="form-control" name="name" placeholder="<?= $f3->get('name') ?>"> <input type="text" class="form-control" name="short_name" placeholder="<?= $f3->get('short_name') ?>"> <button type="submit" class="btn btn-success"><i class="fas fa-plus"></i> <?= $f3->get('add') ?></button></p>
                </form>
              </div>
            </div>
          </div>
