<?php
  ...
  $f3->set('companies_arr',$db->exec('SELECT * FROM companies'));
  $companies = $f3->get('companies_arr');
  ...
  $roles = $f3->set('roles_arr',$db->exec('SELECT * FROM roles'));
...
<head>
  ...
  <title><?php echo $f3->get('dashboard_companies_title'); ?></title>
      ...
      <li class="nav-item">
        ...
        <div id="collapseThree" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active text-<?= $global_settings[17]['value'] ?>" href="./companies"><i class="fas fa-building fa-fw"></i> <?php echo $f3->get('companies'); ?></a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <?php
            if(isset($_SESSION['success']) && $_SESSION['success'] == 'add_company')
            {
              ?>
                <div class="alert alert-success">
                  <?= $f3->get('addcompany_success') ?>
                </div>
              <?php
              unset($_SESSION['success']);
            }
            else if(isset($_SESSION['success']) && $_SESSION['success'] == 'del_company')
            {
              ?>
                <div class="alert alert-success">
                  <?= $f3->get('delcompany_success') ?>
                </div>
              <?php
              unset($_SESSION['success']);
            }
          ...
          <div class="card shadow border-<?= $global_settings[17]['value'] ?>">
            <div class="card-header">
              <h1 class="h3 text-gray-800"><?php echo $f3->get('companies'); ?></h1>
            </div>
            <div class="card-body">
                    ...
                    <?php
                      foreach($companies as $company)
                      {
                        ...
                        <tr>
                          ...
                          <td><?php if($company['game'] == false) echo 'ETS2'; else echo 'ATS' ?></td>
                          <td class="text-center"><a href="./delete_company/<?= $company['id'] ?>"><button class="btn btn-danger"><i class="fas fa-trash"></i> <?= $f3->get('delete') ?></button></a></td>
                        </tr>
                        <?php
                      }
                    ?>
