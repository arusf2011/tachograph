...
<head>
  ...
  <title><?php echo $f3->get('dashboard_recrutation_title'); ?></title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 text-gray-800"><?php echo $f3->get('recrutation'); ?></h1>
            <button disabled class="d-none d-sm-inline-block btn btn-sm btn-<?php if(boolval($global_settings[6]['value']) == false){ echo 'danger'; } else { echo 'success'; } ?> shadow-sm">
              <?php
                if(boolval($global_settings[7]['value']) == false)
                {
                  ?>
                  <i class="fas fa-lock fa-fw"></i> <?= $f3->get('closed') ?>
                  <?php
                }
                else
                {
                  ?>
                  <i class="fas fa-lock-open fa-fw"></i> <?= $f3->get('open') ?>
                  <?php
                }
              ?>
            </button>
          ...
          <?php
            if(isset($_SESSION['success']) && $_SESSION['success'] == 'accept_recruit')
            {
              ?>
                <div class="alert alert-success">
                  <?= $f3->get('acceptrecruit_success') ?>
                </div>
              <?php
          ...
          <div class="row">
            <?php
              require_once './app/list_recruits.php';
            ?>
          </div>
          <div class="modal fade" id="check_modal" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body-recruit modal-body">
                    </div>
                </div>
            </div>
        </div>
  ...
  <script>
    $(document).ready(function(){
      $('.check_btn').on('click',function(){
          ...
          $('.modal-body-recruit').load(data_href,function(){
              $('#check_modal').modal({show:true});
          });
      });
    });
